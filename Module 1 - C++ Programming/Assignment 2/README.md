...
Q2.1 Create a class Box with private members length, width, and height.
Write: 
...
Q2.5 Repeat Q4.1 using malloc and free.

Q2.6 Create a class Student with: 
- rollNo
- name
- marks 
Write the following: 
...
Q2.7 Create a class Employee with: 
